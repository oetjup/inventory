...
<div class="row">
    <div class="col-sm-12 col-md-10">
        <h4 class="mb-0"><i class="fa fa-share"></i> Tambah Data Penerimaan Barang</h4>
    </div>
</div>
<hr class="mt-0" />
<div id="message">
...
<div class="col-md-12">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-6">
            <select class="custom-select custom-select-sm pabean <?= (form_error('pabean')) ? 'is-invalid' : ''; ?>" id="pabean" name="pabean">
                ...
                <?php foreach ($pabean->result() as $p) : ?>
                    <option value="<?= $p->id_pabean; ?>" <?= set_select('pabean',  $p->id_pabean); ?>>
        ...
        <div class="col-sm-6">
            <select class="custom-select custom-select-sm supplier <?= (form_error('supplier')) ? 'is-invalid' : ''; ?>" id="supplier" name="supplier">
                ...
                <?php foreach ($supplier->result() as $s) : ?>
                    <option value="<?= $s->id_supplier; ?>" <?= set_select('supplier',  $s->id_supplier); ?>>
                        <?= $s->nama_supplier; ?>
                    </option>
                <?php endforeach; ?>
            </select>
    ...
    <div class="form-group row">
        ...
        <!-- <div class="col-sm-2">
            <input type="text" class="form-control form-control-sm input-sm" id="satuanx" readonly>
        </div> -->
        <label for="satuanx" class="col-sm-1 col-form-label" id="satuan"></label>
    </div>
    <div class="form-group row">
