...
<div class="row">
    <div class="col-sm-12 col-md-10">
        <h4 class="mb-0"><i class="fa fa-share"></i> Detail Penerimaan Barang</h4>
    </div>
</div>
<hr class="mt-0" />
<h6 class="mb-2">ID Penerimaan</h6>
<p class="text-muted display-5 mt-1 mb-2">#<?= $d->id_pembelian; ?> ( <?= tanggal_indo($d->tgl_pembelian); ?> )</p>
<h6 class="mb-1 mt-2">Pabean</h6>
<p class="text-muted display-5 mt-1 mb-2"><?= $d->kode_dok . ' - ' . $d->nomor_aju; ?></p>
    ...
    <tbody>
        ...
        ?>
            <tr>
                ...
                <td><?= $dd->brand; ?></td>
                <td><?= number_format($dd->qty, 2); ?></td>
                <td><?= $dd->satuan_barang; ?></td>
                <td><?= number_format($dd->hpp, 0, ',', '.'); ?></td>
                <td><?= number_format($dd->bm, 0, ',', '.'); ?></td>
                <td><?= number_format($dd->bmt, 0, ',', '.'); ?></td>
                <td><?= number_format($dd->pph, 0, ',', '.'); ?></td>
                <td><?= number_format($dd->ppn, 0, ',', '.'); ?></td>
                <!--
				<td>
