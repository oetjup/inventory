...
<body>
 ...
 title: 'Apakah anda yakin akan keluar ?', type: 'warning' , showCancelButton: true, confirmButtonColor: '#DD6B55' , confirmButtonText: 'Ya, Sign Out!', closeOnConfirm: false }, function(){ window.location.href = '<?= site_url('sign_out'); ?>'; });">Sign Out</a>
    ...
    <!-- Custom Javascript -->
    <?php
    $arr_uri = array('stok_barang', 'barang', 'pegawai', 'supplier', 'data_pembelian', 'data_penjualan', 'data_pib', 'data_peb', 'produksi_proses');
    ...
    <script>
        ...
        $('#proses').click(function() {
            ...
            alert("Klik Proses " + kode_barang);

            $.ajax({
                url: "<?= site_url('stok_harian'); ?>",
                method: "POST",
                data: {
                    tanggal: tanggal,
                    tanggal2: tanggal2,
