...
<div class="row">
    <div class="col-sm-12 col-md-10">
        <h4 class="mb-0"><i class="fa fa-reply"></i> Tambah Data Sampah Produksi</h4>
    </div>
</div>
<hr class="mt-0" />
<div id="message">
...
<div class="col-md-12">
    <div class="form-group row">
        <label for="no-produksi-sampah" class="col-sm-2 col-form-label">No Produksi Proses</label>
        <div class="col-sm-6">
    ...
    <div class="form-group row">
        <label for="no-produksi-sampah" class="col-sm-2 col-form-label">No Sampah Produksi</label>
        <div class="col-sm-3">
            <input type="text" name="no-produksi-sampah" id="no-produksi-sampah" class="form-control form-control-sm <?= (form_error('no-produksi-sampah')) ? 'is-invalid' : ''; ?>" placeholder="Nomor Produksi" value="<?= (set_value('no-produksi-sampah')) ? set_value('no-produksi-sampah') : 'PSCR' . time(); ?>">
            <div class="invalid-feedback">
                <?= form_error('no-produksi-sampah', '<p class="error-message">', '</p>'); ?>
            </div>
        </div>
    </div>
    <div class="form-group row">
    ...
    <div class="form-group row">
        <div class="col-sm-3 offset-sm-2">
            ...
            <div id="btn-act">
                <button type="button" class="btn btn-success btn-sm tambah-produksi-sampah" onclick="tambah_cart_produksi_sampah()">
                    Tambah Barang
                </button>
            </div>
        </div>
    ...
    <div class="col-sm-6 offset-sm-8">
        <button type="submit" name="submit" class="btn btn-primary btn-sm" value="Submit">
            <i class="fa fa-save"></i> Simpan Sampah Produksi
        </button>
