...
<head>
    ...
    <title>Login Aplikasi IT Inventory</title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-sm-12 text-center mt-5 mb-3">
                <img src="<?= base_url('assets/img/inventory.png'); ?>" class="login" />
                <h3 class="text-white mt-2">Aplikasi IT Inventory</h3>
            ...
            <div class="col-md-4 col-sm-12 offset-md-4">
                <div class="jumbotron py-3 pt-4">
                    ...
                    <div class="form-group float-right">
                        <button type="submit" name="submit" value="submit" class="btn btn-primary text-white btn-sm">Sign In <i class="fa fa-sign-in"></i></button>
                    </div>
