...
<h6 class="display-5 text-center mt-2 mb-0">Laporan Bulanan Pemasukan Barang</h6>
    ...
    <tbody>
        ...
        if ($data->num_rows() > 0) {
            ...
            foreach ($data->result() as $dt) {
                ...
                echo '<td>' . $dt->brand . '</td>';
                echo '<td>' . number_format($dt->qty, 0, ',', '.') . '</td>';
                echo '<td>' . $dt->satuan_barang . '</td>';
                echo '<td>' . number_format($dt->hpp, 0, ',', '.') . '</td>';
                echo '<td>' . number_format($dt->bm, 0, ',', '.') . '</td>';
                echo '<td>' . number_format($dt->bmt, 0, ',', '.') . '</td>';
                echo '<td>' . number_format($dt->pph, 0, ',', '.') . '</td>';
                echo '<td>' . number_format($dt->ppn, 0, ',', '.') . '</td>';
