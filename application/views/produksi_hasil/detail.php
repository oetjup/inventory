...
<div class="row">
    <div class="col-sm-12 col-md-10">
        <h4 class="mb-0"><i class="fa fa-share"></i> Detail Hasil Produksi</h4>
    </div>
</div>
<hr class="mt-0" />
<h6 class="mb-2">No Produksi Proses</h6>
<p class="text-muted display-5 mt-1 mb-2">#<?= $d->no_produksi; ?> ( <?= tanggal_indo($d->tgl_produksi); ?> )</p>
<h6 class="mb-2">No Hasil Produksi</h6>
<p class="text-muted display-5 mt-1 mb-2">#<?= $d->no_produksi_hasil; ?> ( <?= tanggal_indo($d->tgl_produksi_hasil); ?> )</p>
