...
<div class="row">
    <div class="col-sm-12 col-md-10">
        <h4 class="mb-0"><i class="fa fa-reply"></i> Edit Hasil Produksi</h4>
    </div>
</div>
<hr class="mt-0" />
<div id="message">
...
<?= form_open(); ?>
<input type="hidden" name="idP" value="<?= $fdata->id_produksi_hasil; ?>">
<div class="col-md-12">
    <div class="form-group row">
        <label for="no-produksi-hasil" class="col-sm-2 col-form-label">Nomor Hasil Produksi</label>
        <div class="col-sm-3">
            <input type="text" name="no-produksi-hasil" id="no-produksi-hasil" class="form-control form-control-sm <?= (form_error('no-produksi-hasil')) ? 'is-invalid' : ''; ?>" placeholder="Nomor Produksi" value="<?= (set_value('no-produksi-hasil')) ? set_value('no-produksi-hasil') : $fdata->no_produksi_hasil; ?>">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-3">
            <input type="text" class="form-control form-control-sm <?= (form_error('tanggal')) ? 'is-invalid' : ''; ?>" name="tanggal" id="date-picker" value="<?= (set_value('tanggal')) ? set_value('tanggal') : date('d/m/Y', strtotime($fdata->tgl_produksi_hasil)); ?>">
            <div class="invalid-feedback">
    ...
    <div class="form-group row">
        <div class="col-sm-3 offset-sm-2">
            ...
            <div id="btn-act">
                <button type="button" class="btn btn-success btn-sm tambah-penjualan" onclick="tambah_cart_produksi_hasil()">
                    Tambah Barang
                </button>
            </div>
        </div>
