...
class M_laporan extends CI_Model
{
    ...
    function getDataStokHarian($tanggal, $tanggal2, $where = null)
    {
        // $table = 'tbl_barang b
        //             LEFT JOIN
        ...
        $select = 'kode_barang, nama_barang, brand, stok, c.qty AS qty_penjualan, d.qty AS qty_pembelian, e.qty AS qty_penjualan_new, f.qty AS qty_pembelian_new, nama_kat_barang, x.qty AS qty_penjualan_bef, y.qty AS qty_pembelian_bef';
