...
class M_pembelian extends CI_Model
{
    ...
    {
        $select = 'p.id_pembelian AS id_pembelian, tgl_pembelian, qty, dp.harga AS harga, kode_barang, nama_barang, satuan_barang, hpp, bm, bmt, pph, ppn, brand, fullname, u.id_user AS id_user, nama_supplier, p.id_supplier AS id_supplier, pa.id_pabean AS id_pabean, pa.nomor_aju AS nomor_aju, , pa.kode_dok AS kode_dok';
